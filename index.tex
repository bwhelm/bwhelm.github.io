...
\textbf{Note:} Links to preprints are to the first chapter. I'm happy to send full .pdfs on request.
...
Download links to published articles are mostly to late drafts; see the relevant journals or volumes for the definitive versions, or contact me directly to request .pdf copies.
