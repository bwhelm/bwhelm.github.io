...
% % Existing keywords (12/28/2023). FIXME: Update the `Other` category, below!
% personhood
% rationality
% social ontology
% social identity
...
Select a category below. Comments on any of these would be appreciated.

\paragraph{Complete List (by Date)}

\printbibliography[filter=myarticle]

\paragraph{Personhood}
...
\paragraph{Social Ontology}

\printbibliography[filter=myarticle,keyword={social ontology}]

\paragraph{Social Identity}

\printbibliography[filter=myarticle,keyword={social identity}]

\paragraph{Moral Psychology and Value Theory}

\defbibfilter{mporvt}{keyword={moral psychology} or keyword={value theory}}

\printbibliography[filter=myarticle,filter=mporvt]
...
\printbibliography[filter=myarticle,keyword={love}]

\paragraph{Friendship}

\printbibliography[filter=myarticle,keyword={friendship}]

\paragraph{Mind/Emotion}

\printbibliography[filter=myarticle,keyword=mind/emotion]

% \paragraph{Belief}

% \printbibliography[filter=myarticle,keyword={belief}]

% \paragraph{Other}% FIXME!

% \printbibliography[filter=myarticle,notkeyword={personhood},notkeyword={rationality},notkeyword={social ontology},notkeyword={social identity},notkeyword={moral psychology},notkeyword={value theory},notkeyword={agency},notkeyword={love},notkeyword={friendship},notkeyword={mind/emotion},notkeyword={belief},notkeyword={popular}]

\paragraph{Popular}

\printbibliography[filter=myarticle,keyword={popular}]
